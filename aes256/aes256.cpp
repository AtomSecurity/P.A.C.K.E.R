...
ByteArray::size_type Aes256::decrypt_end(ByteArray& plain) { return plain.size(); }
...
inline unsigned char rj_xtime(unsigned char x) { return (x & 0x80) ? ((x << 1) ^ 0x1b) : (x << 1); }